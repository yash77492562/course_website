...
function CourseContent({ course, courseId }: { course: Course; courseId: string }) {
  ...
  return (
    <>
      ...
      <section className="pt-[100px] md:pt-[140px] pb-[40px] md:pb-[80px] px-[5vw] bg-transparent relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-10 md:gap-[60px] items-start max-w-7xl mx-auto relative z-10">
          ...
          <div className="min-w-0 flex flex-col pt-4">
            ...
            <h1 className="font-display italic text-[2.25rem] md:text-[clamp(2.5rem,5vw,4rem)] font-bold leading-[1.1] tracking-[-0.02em] text-[#0f172a] mb-6">
              {programData.headline}
            </h1>
            
            <p className="text-[1rem] md:text-[1.15rem] leading-[1.7] text-[#475569] max-w-[600px] mb-10">
              {programData.subheadline}
            </p>

            <div className="grid grid-cols-2 md:flex md:flex-wrap gap-4 mb-10">
              <div className="order-1 md:order-none bg-white/60 backdrop-blur-md border border-white/80 rounded-2xl p-5 min-w-0 md:min-w-[170px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] transition-transform hover:-translate-y-1">
                <div className="text-[0.7rem] sm:text-[0.75rem] font-semibold tracking-[0.1em] uppercase text-slate-500 mb-2">Spots left</div>
                <div className="font-sans font-extrabold text-[#0f172a] text-[1.25rem] sm:text-[1.5rem] flex items-center gap-2">
              ...
              <div className="order-3 md:order-none col-span-2 md:col-span-1 bg-white/60 backdrop-blur-md border border-white/80 rounded-2xl p-5 min-w-0 md:min-w-[170px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] transition-transform hover:-translate-y-1">
                <div className="text-[0.7rem] sm:text-[0.75rem] font-semibold tracking-[0.1em] uppercase text-slate-500 mb-2">Next cohort</div>
                <div className="font-sans font-bold text-[#0f172a] text-[1rem] sm:text-[1.15rem] leading-tight">{programData.nextCohort}</div>
              </div>
              <div className="order-2 md:order-none bg-white/60 backdrop-blur-md border border-white/80 rounded-2xl p-5 min-w-0 md:min-w-[170px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] transition-transform hover:-translate-y-1">
                <div className="text-[0.7rem] sm:text-[0.75rem] font-semibold tracking-[0.1em] uppercase text-slate-500 mb-2">Investment</div>
                <div className="font-sans font-extrabold text-primary text-[1.25rem] sm:text-[1.5rem]">{programData.price}</div>
              </div>
            </div>
            ...
            {!showPaymentButtons && (
              <div className="flex flex-col sm:flex-row gap-4 mt-4 items-start sm:items-center p-6 bg-blue-50/50 border border-blue-100 rounded-2xl">
                <div className="flex-1">
                  <div className="font-bold text-blue-800 text-lg mb-1">✅ You're Enrolled</div>
                  <p className="text-blue-600 text-sm m-0">You have full lifetime access to this program.</p>
                </div>
                <a href={`/video-player/${programData.modules[0]?.lessons?.[0]?.id}`} className="w-full sm:w-auto inline-flex justify-center min-w-[160px] items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-[15px] px-[32px] rounded-full font-bold text-[1rem] no-underline transition-all duration-300 shadow-[0_4px_20px_rgba(37,99,235,0.25)] hover:shadow-[0_8px_30px_rgba(37,99,235,0.35)] hover:-translate-y-1 border-none cursor-pointer">
                  Continue Learning →
                </a>
              </div>
            )}
          ...
          <div className={`min-w-0 self-center ${!showPaymentButtons ? 'hidden md:block' : ''}`}>
            <div 
              className="border border-slate-100 rounded-[24px] p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] relative w-full mt-5 md:mt-0"
            ...
            >
              {showPaymentButtons ? (
                <>
                  ...
                  <PayNowButton className="w-full justify-center flex text-decoration-none items-center gap-2 bg-blue-600 hover:bg-blue-700 shadow-md text-white py-[16px] px-[30px] rounded-xl font-bold text-[1.05rem] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(37,99,235,0.25)] border-none cursor-pointer">
                    Enroll Now
                  </PayNowButton>
                  ...
                  <div className="flex flex-col gap-3.5 mt-8 pt-6 border-t border-slate-100">
                    ...
                    <div className="flex items-start gap-3 text-[0.95rem] text-slate-600">
                      <div className="mt-0.5 text-blue-500"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                ...
                <>
                  <div className="mb-6 text-center">
                    <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                      <svg className="text-blue-600" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    </div>
                    <div className="text-[0.75rem] font-bold tracking-[0.15em] uppercase text-blue-600 mb-2">Status</div>
                  ...
                  <a href={`/video-player/${programData.modules[0]?.lessons?.[0]?.id}`} className="w-full justify-center flex text-decoration-none items-center gap-2 bg-blue-600 hover:bg-blue-700 shadow-md text-white py-[16px] px-[30px] rounded-xl font-bold text-[1.05rem] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(37,99,235,0.2)] border-none cursor-pointer">
                    Continue Learning
                  </a>
                </>
              )}
      ...
      <ProgramOutcomeSection 
        ...
        hasPurchasedProp={!showPaymentButtons}
      />

      {/* Career Support & FAQs Section */}
      <CareerSupportSection faqs={programData.faqs} />

      {/* Spacer to prevent sticky bar from overlapping final content */}
      {showPaymentButtons && <div className="h-[90px] md:h-[100px] w-full" />}
      ...
      {showPaymentButtons && (
        <div className="fixed left-0 right-0 bottom-0 bg-white/90 backdrop-blur-md border-t border-slate-200 z-[999]">
          <div className="max-w-7xl mx-auto py-3 px-[5vw] flex justify-between items-center gap-2 md:gap-3.5">
            <div className="flex-1 min-w-0">
              <div className="font-sans font-bold text-[0.85rem] sm:text-[0.95rem] md:text-base text-slate-900 truncate">{programData.badge}</div>
              <div className="font-sans font-normal text-[0.7rem] sm:text-[0.75rem] md:text-sm text-slate-500 truncate">Spots left: {programData.spotsLeft} • {programData.price}</div>
            </div>
            <PayNowButton className="shrink-0 inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 shadow-sm text-white py-2.5 px-4 md:py-3.5 md:px-[30px] rounded-lg font-bold text-[0.85rem] md:text-[0.95rem] no-underline transition-all duration-200 shadow-[0_4px_24px_rgba(37,99,235,0.35)] hover:shadow-[0_8px_32px_rgba(37,99,235,0.45)] hover:-translate-y-[2px] border-none cursor-pointer">Pay Now</PayNowButton>
          </div>
        </div>
      )}
