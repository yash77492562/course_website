...
export function CourseHero({
  ...
  return (
    <section className={`bg-gradient-to-br from-blue-600 to-purple-700 text-foreground py-20 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-border">
